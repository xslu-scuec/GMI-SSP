...
#ifndef __elxMultiMetricMultiResolutionRegistrationWithFeatures_H__
#define __elxMultiMetricMultiResolutionRegistrationWithFeatures_H__

#include "itkMultiMetricMultiResolutionImageRegistrationMethodWithFeatures.h"
...
namespace elastix
{
  ...
  /**
   * \class MultiMetricMultiResolutionRegistrationWithFeatures
   * \brief A registration framework based on the
   *   itk::MultiMetricMultiResolutionImageRegistrationMethodWithFeatures.
   *
   * This MultiMetricMultiResolutionRegistrationWithFeatures gives a framework for 
   * registration with a multi-resolution approach, using ...
   ...
   *    <tt>(Registration "MultiMetricMultiResolutionRegistrationWithFeatures")</tt>
  ...
  public:
    ...
    /** Standard ITK: Self */
    typedef MultiMetricMultiResolutionRegistrationWithFeatures                    Self;
    typedef itk::MultiMetricMultiResolutionImageRegistrationMethodWithFeatures<
      typename RegistrationBase<TElastix>::FixedImageType,
      typename RegistrationBase<TElastix>::MovingImageType >
                                                                                  Superclass1;
    ...
    itkTypeMacro( MultiMetricMultiResolutionRegistrationWithFeatures,
     ...
     * example: <tt>(Registration "MultiMetricMultiResolutionRegistrationWithFeatures")</tt>\n
     */
    elxClassNameMacro( "MultiMetricMultiResolutionRegistrationWithFeatures" );
    ...
    /** The CombinationMultiInputMetric type, which is used internally by the Superclass1 */
    typedef typename 
	  Superclass1::CombinationMultiInputMetricType          CombinationMultiInputMetricType;
    typedef typename 
	  Superclass1::CombinationMultiInputMetricPointer       CombinationMultiInputMetricPointer;
  ...
  protected:
    ...
    /** The destructor. */
    virtual ~MultiMetricMultiResolutionRegistrationWithFeatures() {};
  ...
  private:
    ...
    MultiMetricMultiResolutionRegistrationWithFeatures( const Self& ); // purposely not implemented
    /** The private copy constructor. */
    void operator=( const Self& );              // purposely not implemented

  }; // end class MultiMetricMultiResolutionRegistrationWithFeatures


} // end namespace elastix

#ifndef ITK_MANUAL_INSTANTIATION
#include "elxMultiMetricMultiResolutionRegistrationWithFeatures.hxx"
#endif

#endif // end #ifndef __elxMultiMetricMultiResolutionRegistrationWithFeatures_H__
