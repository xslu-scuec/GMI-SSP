...
::BeforeRegistration( void )
{
  ...
  /** Get and set bool variable which decides to use Multi-thread or not. */
  bool useKNNMultiThread = false;
  this->m_Configuration->ReadParameter( useKNNMultiThread, "UseKNNMultiThread", 0 );
  this->SetUseKNNMultiThread( useKNNMultiThread );

  /** Get and set the number of threads if Multi-thread is used. */
  unsigned int knnNumberOfThreads = 2;
  this->m_Configuration->ReadParameter( knnNumberOfThreads, "KNNNumberOfThreads", 0 );
  this->SetKNNNumberOfThreads( knnNumberOfThreads );
...
::BeforeEachResolution( void )
{
  ...
  this->m_Configuration->ReadParameter( kNearestNeighbours,
    "KNearestNeighbours", 0 );
  this->m_Configuration->ReadParameter( kNearestNeighbours,
    "KNearestNeighbours", level, true );
  ...
  this->m_Configuration->ReadParameter( squaredSearchRadius,
    "SquaredSearchRadius", 0, silentSR );
  this->m_Configuration->ReadParameter( squaredSearchRadius,
