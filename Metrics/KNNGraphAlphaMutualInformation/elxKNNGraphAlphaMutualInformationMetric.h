 ...
 *    The default is 1e-5.
 * \parameter UseKNNMultiThread: This parameter decides to use Multi-thread or not. \n
 *    The default is false for all resolutions.
 * \parameter KNNNumberOfThreads: The number of threads if Multi-thread is used. \n
 *    The default is 2 for all resolutions.
 *
